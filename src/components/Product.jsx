       ...
       <Link to={`/products/${product.id}`}>
        ...
        <div>
            ...
            <div className="flex items-center justify-between mt-3">
                <button onClick={()=>dispatch(addToBag(product))} className='md:hover:scale-105 duration-300 bg-slate-400 text-white px-2 py-[5px] rounded-md fw-medium'>Add to Bag</button>
